...
public class StressMetrics
{
    ...
    public void summarise()
    {
        ...
        output.println(String.format("Op rate                   : %,10.0fop/s  %s", history.opRate(), opHistory.opRates()));
        output.println(String.format("Partition rate            : %,10.0fpk/s  %s", history.partitionRate(), opHistory.partitionRates()));
        output.println(String.format("Row rate                  : %,10.0frow/s %s", history.rowRate(), opHistory.rowRates()));
        output.println(String.format("Latency mean              : %12.1fms %s", history.meanLatency(), opHistory.meanLatencies()));
        output.println(String.format("Latency median            : %12.1fms %s", history.medianLatency(), opHistory.medianLatencies()));
        output.println(String.format("Latency 95th percentile   : %12.1fms %s", history.rankLatency(.95f), opHistory.rankLatencies(0.95f)));
        output.println(String.format("Latency 99th percentile   : %12.1fms %s", history.rankLatency(0.99f), opHistory.rankLatencies(0.99f)));
        output.println(String.format("Latency 99.9th percentile : %12.1fms %s", history.rankLatency(0.999f), opHistory.rankLatencies(0.999f)));
        output.println(String.format("Latency max               : %12.1fms %s", history.maxLatency(), opHistory.maxLatencies()));
        ...
        output.println(String.format("Total GC count            : %,10.0f", totalGcStats.count));
        output.println(String.format("Total GC memory           : %13s", FBUtilities.prettyPrintMemory((long)totalGcStats.bytes)));
        output.println(String.format("Total GC time             : %,12.1fs", totalGcStats.summs / 1000));
        output.println(String.format("Avg GC time               : %,12.1fms", totalGcStats.summs / totalGcStats.count));
        output.println(String.format("StdDev GC time            : %,12.1fms", totalGcStats.sdvms));
